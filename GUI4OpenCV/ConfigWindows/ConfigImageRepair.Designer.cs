...
{
    partial class ConfigImageRepair
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // v
            // 
            v.Location = new Point(118, 134);
            v.Maximum = new decimal(new int[] { 255, 0, 0, 0 });
            v.Name = "v";
            v.Size = new Size(92, 23);
            v.TabIndex = 1;
            v.TextAlign = HorizontalAlignment.Center;
            v.Value = new decimal(new int[] { 6, 0, 0, 0 });
            // 
            // ConfigImageRepair
            // 
            ...
            Controls.Add(r);
            Controls.Add(label1);
            Name = "ConfigImageRepair";
            Text = "ConfigImageRepair";
